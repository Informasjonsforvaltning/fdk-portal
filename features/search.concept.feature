...
Scenario Outline: Concept that exists in chosen language
  Given "<searchTerm>" has <numberOf> exact matches in "<language>"
  When I choose "<language>" as my system language
...
Scenario Outline: Concept that has no hits for chosen language
  Given "<searchTerm>" does not have any hits with exact match for "<language>"
...
Scenario Outline: Concept that has hits in chosen language and hits in other languages
  Given  "<searchTerm>" has hits with exact match for "<language>"
