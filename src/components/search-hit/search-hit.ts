import SearchHitSC from './components/search-hit/styled';
import SearchHitHeadSC from './components/search-hit-head/styled';

export { SearchHit } from './components/search-hit/search-hit.component';
...
export const SC = {
  SearchHit: SearchHitSC,
  SearchHitHead: SearchHitHeadSC
};
